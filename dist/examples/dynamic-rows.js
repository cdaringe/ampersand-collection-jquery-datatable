 ...
 *     dtOptions: {Object}, // dataTable init Object
...
CollectionDataTable.prototype.setCollection = function(col) {
    ...
    col.on('all', function(model) {console.log('giddy up');});
};
...
CollectionDataTable.prototype.handleCollectionAdd = function(model, options) {
    options = options || {};
    console.log('COLLECTION UPDATED WITH NEW');
...
/**
 * Fetches model collection and triggers table update
 * @return {Promise} resolves with data, rejects with err
 */
CollectionDataTable.prototype.fetch = function () {
    var self = this;
    if (!this.collection.fetch) {
        throw new TypeError('Collection is not an ampersand-rest-collection');
    }
    return new Promise(function(resolve, reject) {
        return this.collection.fetch({
            success: function (r) {
                self.handleModelFetchSuccess(r);
                resolve(r);
                return;
            },
            error: function (err) {
...
/**
 * Handle model fetch success
 * @param  {Collection} r Ampersand Collection
 * @return {this}
 */
CollectionDataTable.prototype.handleModelFetchSuccess = function () {
...
},{"jquery":35,"rsvp":36,"underscore":37}],2:[function(require,module,exports){
...
},{"ampersand-state":23,"ampersand-sync":9,"underscore":37}],9:[function(require,module,exports){
var _ = require('underscore');
var xhr = require('xhr');
var qs = require('qs');
...
},{"qs":10,"underscore":15,"xhr":16}],10:[function(require,module,exports){
...
},{"array-next":24,"backbone-events-standalone":26,"key-tree-store":27,"underscore":37}],24:[function(require,module,exports){
...
},{"oMfpAn":34}],37:[function(require,module,exports){
//     Underscore.js 1.7.0
//     http://underscorejs.org
//     (c) 2009-2014 Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
//     Underscore may be freely distributed under the MIT license.
...
var dummyData = [
    new TestModel({a: 'a1', b: 'b1', c: 'c1', d: 'd1'}),
    new TestModel({a: 'a2', b: 'b2', c: 'c2', d: 'd2'}),
    new TestModel({a: 'a3', b: 'b3', c: 'c3', d: 'd3'})
];
...
},{"../../ampersand-collection-jquery-datatable":1,"ampersand-collection":2,"ampersand-model":8,"datatables":28,"domready":30,"jquery":35}]},{},[38])